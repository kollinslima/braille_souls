...
Modifications copyright (C) 2018 Kollins Lima (kollins.lima@gmail.com)
...
//        h = 17;
    ...
    public ClockView(Context context, AttributeSet attrs) {
        ...
        pc = arr.getColor(R.styleable.ClockView_clockPointerColor, Color.parseColor("#F44336"));
...
//    }
    ...
    public void setClockPointerColor(int pc) {
        this.pc = pc;
    }
